...
///
/// Skrepka's own rather than `KeyboardShortcuts.Recorder`: that view reaches
...
final class ShortcutRecorderField: NSView {
    ...
    /// matters for more than the monitor: recording disables Skrepka's global
    ...
    /// before that happens. Skrepka's own global hotkey is suspended for the
