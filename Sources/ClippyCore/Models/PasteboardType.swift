...
/// Pasteboard type identifiers Clippy reads and writes.
///
/// Spelled as raw strings so `ClippyCore` stays free of AppKit view types; the
...
public enum PasteboardType {
    ...
    /// Clippy sets it on paste-back so other clipboard managers do not
    /// attribute restored content to Clippy.
