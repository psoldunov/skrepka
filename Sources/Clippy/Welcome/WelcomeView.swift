...
/// general pasteboard, and the alert fires on Clippy's first read whenever that
...
struct WelcomeView: View {
    ...
    /// is re-read when Clippy comes forward.
    ...
    var body: some View {
        ...
        // Granting happens in System Settings, so returning to Clippy is the
    ...
    /// Done stays disabled until Clippy can actually read the clipboard.
    ///
    ...
    private var permissionSubtitle: String {
        switch clipboardStatus {
        case .working: "Clippy is recording what you copy."
        case .blocked: "macOS is blocking Clippy from reading it."
    ...
    private var permissionFooter: String {
        ...
        case .unknown:
            didRequestAccess
                ...
                : "Clippy copies a marker and reads it back. That is what prompts macOS."
        }
    }
