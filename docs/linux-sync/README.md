...
**Status, 2026-09-07: Phases 1, 2, 3 and 5 built, Phase 4 done bar its
...
which Mac ↔ Linux sync actually works.
...
| `scripts/doctor.sh` | **526 tests / 69 suites green** |
| `scripts/doctor-linux.sh` | **481 tests / 58 suites green, SwiftLint included** — 17 of them driving a headless Sway and an Xvfb started by the test |
